...
import android.hardware.hdmi.HdmiControlManager.CecSettingChangeListener;
...
public class DroidLogicHdmiCecManager {
    ...
    private DroidLogicHdmiCecManager(Context context) {
        ...
        mHdmiControlManager.addHdmiCecEnabledChangeListener(new CecSettingChangeListener() {
            @Override
            public void onChange(String setting) {
                boolean enabled = mHdmiControlManager.getHdmiCecEnabled()
